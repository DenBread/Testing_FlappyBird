...
IL_037b:
	{
		...
		V_30 = (bool)((!(((RuntimeObject*)(OnValidateInput_t88ECDC5C12A807AF2A5761369563B0FAA6A25530*)L_96) <= ((RuntimeObject*)(RuntimeObject*)NULL)))? 1 : 0);
		bool L_97 = V_30;
		if (!L_97)
		{
			goto IL_03ac;
...
IL_03ac:
	{
		...
		V_31 = (bool)((!(((uint32_t)L_104) <= ((uint32_t)0)))? 1 : 0);
		bool L_105 = V_31;
		if (!L_105)
		{
			goto IL_03d6;
	...
	}
	{
		...
		Il2CppChar L_109 = V_28;
		Il2CppChar L_110;
		L_110 = TMP_InputField_Validate_m76212763DA49DFD7C152C65F8AF6CC056EE69979(__this, L_106, L_108, L_109, NULL);
		V_28 = L_110;
	}
...
IL_03d6:
	...
	}
	{
		...
		G_B93_0 = ((((int32_t)L_112) == ((int32_t)((int32_t)10)))? 1 : 0);
		goto IL_03e8;
	}
...
IL_0416:
	...
	}
	{
		...
		G_B98_0 = ((((int32_t)((((int32_t)L_117) == ((int32_t)8))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_0429;
	}
...
IL_0429:
	...
	}
	{
		...
		String_t* L_120;
		L_120 = Char_ToString_m2A308731F9577C06AF3C0901234E2EAC8327410C((&V_28), NULL);
		String_t* L_121;
		L_121 = String_Concat_m9E3155FB84015C823606188F53B47CB44C444991(L_119, L_120, NULL);
		__this->___m_Text = L_121;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___m_Text), (void*)L_121);
	}
...
IL_044e:
	{
		...
		V_34 = (bool)((((int32_t)L_123) < ((int32_t)L_125))? 1 : 0);
		bool L_126 = V_34;
		if (L_126)
		{
			goto IL_0358;
	...
	{
		int32_t L_127;
		L_127 = TMP_InputField_get_characterLimit_m59833E0A22BACBDF3EDA6A70A30B87272FBAA409(__this, NULL);
	...
	}
	{
		...
		G_B105_0 = ((((int32_t)L_129) > ((int32_t)L_130))? 1 : 0);
		goto IL_0480;
	}
...
IL_0480:
	...
	{
		String_t* L_132 = __this->___m_Text;
		int32_t L_133;
		L_133 = TMP_InputField_get_characterLimit_m59833E0A22BACBDF3EDA6A70A30B87272FBAA409(__this, NULL);
		NullCheck(L_132);
		String_t* L_134;
		L_134 = String_Substring_mB1D94F47935D22E130FF2C01DBB6A4135FBB76CE(L_132, 0, L_133, NULL);
		__this->___m_Text = L_134;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___m_Text), (void*)L_134);
	}
...
IL_049e:
	...
	}
	{
		...
		NullCheck(L_139);
		TouchScreenKeyboard_set_text_m0A8AA05F4D9D27E8764955F0041452145B6C6FBB(L_139, L_140, NULL);
	}
...
IL_04d7:
	{
		bool L_141 = __this->___m_HideMobileInput;
		if (!L_141)
		{
			goto IL_050a;
		}
	...
	}
	{
		...
		NullCheck(L_143);
		bool L_144;
		L_144 = TouchScreenKeyboard_get_canSetSelection_m6CD6C069A9FEF91CC8014B877EB057ECF598EDF9(L_143, NULL);
		if (!L_144)
		{
			goto IL_050a;
		}
	...
	}
	{
		...
		G_B117_0 = ((((int32_t)((((int32_t)L_146) == ((int32_t)((int32_t)31)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_050b;
	}
...
IL_050b:
	...
	{
		int32_t L_148;
		L_148 = TMP_InputField_get_caretSelectPositionInternal_m977002CC2C821A3B4FA5FB3F1BC15C7DD0BA35A4(__this, NULL);
		int32_t L_149;
		L_149 = TMP_InputField_get_caretPositionInternal_m21C9BFCD70C944B374E5C916C7E7E67B75B831EA(__this, NULL);
		int32_t L_150;
		L_150 = Mathf_Min_m888083F74FF5655778F0403BB5E9608BEFDEA8CB_inline(L_148, L_149, NULL);
		V_38 = L_150;
		int32_t L_151;
		...
		int32_t L_153;
		L_153 = Mathf_Abs_mD945EDDEA0D62D21BFDBAB7B1C0F18DFF1CEC905_inline(((int32_t)il2cpp_codegen_subtract(L_151, L_152)), NULL);
		V_39 = L_153;
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_154 = __this->___m_SoftKeyboard;
		int32_t L_155 = V_38;
		int32_t L_156 = V_39;
		RangeInt_tDFBE4FD13857C11F21F7C3DA6B60D05341B67268 L_157;
		memset((&L_157), 0, sizeof(L_157));
		RangeInt__ctor_m3CB91E79C7B5AED97E564581025B2F66778B7CBE((&L_157), L_155, L_156, NULL);
		NullCheck(L_154);
		TouchScreenKeyboard_set_selection_mC27C2948118086822A151118C379FAAF692DB2DF(L_154, L_157, NULL);
		goto IL_0598;
	}

IL_0551:
	{
		bool L_158 = __this->___m_HideMobileInput;
		if (!L_158)
		{
			goto IL_0562;
		}
...
IL_0562:
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_160 = __this->___m_SoftKeyboard;
		NullCheck(L_160);
		bool L_161;
		L_161 = TouchScreenKeyboard_get_canSetSelection_m6CD6C069A9FEF91CC8014B877EB057ECF598EDF9(L_160, NULL);
		if (!L_161)
		{
			goto IL_0585;
		}
	...
	}
	{
		...
		G_B125_0 = ((((int32_t)L_163) == ((int32_t)((int32_t)31)))? 1 : 0);
		goto IL_0583;
	}
...
IL_0598:
	...
	}
	{
		...
		NullCheck(L_166);
		int32_t L_167;
		L_167 = TouchScreenKeyboard_get_status_mCC466FDEC7E1913D8585ABA7F048FC198CB19504(L_166, NULL);
		G_B134_0 = ((!(((uint32_t)L_167) <= ((uint32_t)0)))? 1 : 0);
		goto IL_05b1;
	}
...
IL_05b1:
	...
	}
	{
		...
		V_42 = (bool)((((int32_t)L_170) == ((int32_t)2))? 1 : 0);
		bool L_171 = V_42;
		if (!L_171)
		{
			goto IL_05d3;
...
IL_02c3:
	{
		Event_tEBC6F24B56CE22B9C9AD1AC6C24A6B83BC3860CB* L_56 = ___0_evt;
		NullCheck(L_56);
		Il2CppChar L_57;
		L_57 = Event_get_character_m8F7A92E90EF65B9379C01432B42D6BF818C32A61(L_56, NULL);
		V_5 = L_57;
		bool L_58;
		L_58 = TMP_InputField_get_multiLine_m3000150A39B90BCFFAFD41E0F49F479323F045B7(__this, NULL);
		if (L_58)
		{
			goto IL_02ea;
		}
	...
	{
		Il2CppChar L_60 = V_5;
		if ((((int32_t)L_60) == ((int32_t)((int32_t)13))))
		{
			goto IL_02e7;
		}
	}
	{
		Il2CppChar L_61 = V_5;
		G_B65_0 = ((((int32_t)L_61) == ((int32_t)((int32_t)10)))? 1 : 0);
		goto IL_02e8;
	}
...
IL_02f6:
	{
		Il2CppChar L_63 = V_5;
		if ((((int32_t)L_63) == ((int32_t)((int32_t)13))))
		{
			goto IL_0303;
		}
	}
	{
		Il2CppChar L_64 = V_5;
		G_B72_0 = ((((int32_t)L_64) == ((int32_t)3))? 1 : 0);
		goto IL_0304;
	}
...
IL_030e:
	...
	{
		Il2CppChar L_67 = V_5;
		G_B77_0 = ((((int32_t)L_67) == ((int32_t)((int32_t)10)))? 1 : 0);
		goto IL_031a;
	}
...
IL_0324:
	{
		Il2CppChar L_69 = V_5;
		bool L_70;
		L_70 = VirtualFuncInvoker1< bool, Il2CppChar >::Invoke(67, __this, L_69);
		V_19 = L_70;
		bool L_71 = V_19;
		if (!L_71)
		{
	...
	{
		Il2CppChar L_72 = V_5;
		VirtualActionInvoker1< Il2CppChar >::Invoke(71, __this, L_72);
	}
...
IL_033d:
	...
	{
		int32_t L_75;
		L_75 = TMP_InputField_get_compositionLength_m444E57B7F68C9AECE1CDEBF4732FAD66EBA4937F(__this, NULL);
		V_21 = (bool)((((int32_t)L_75) > ((int32_t)0))? 1 : 0);
		bool L_76 = V_21;
		if (!L_76)
		{
			goto IL_0361;
